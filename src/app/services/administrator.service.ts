...
export class AdministratorService {
  ...
  deleteSelfQuestion(id : number){
    return this.http.delete(`${baseUrl}/learning-objects/object-learning-question-evaluation-schema-delete/${id}`);
  }
  ...
  getEvaluationAutomaticQuestion(){
    return this.http.get<SelfQuestion[]>(`${ baseUrl }/object-learning-question-evaluation-schema/`).pipe(map((data: any) => data));
  }
  ...
  retrieveEvaluationAutomaticQuestion(id: number){
    return this.http.get<SelfQuestion>(`${ baseUrl }/object-learning-question-evaluation-schema/${id}/`).pipe(map((data: any) => data));
  }
  ...
  putRelatioshipQuestionMetadata(data:any){
    return this.http.put(`${baseUrl}/learning-objects/add-metadata-question-relationship/`,data);
  }
  
  deleteRelatioshipQuestionMetadata(data:any){
    return this.http.delete(`${baseUrl}/learning-objects/add-metadata-question-relationship/${data.id_schema}`);
  }
  ...
  getMetadataConceptQuestionsExpert(){
    return this.http.get(`${ baseUrl }/learning-objective-assessment-schema/`).pipe(map((data: any) => data));
  }
  ...
  listLearningObject(status: number, data_filter:any = null){
    return this.http.get(`${ baseUrl }/learning-objects-approved-and-disapproved/${status}/`, {params:data_filter}).pipe(map((data: any) => data));
  }

  //Listar los objetos de aprendizaje con paginacion
  listLearningObjectPagination(status: number, page : number){
    return this.http.get(`${ baseUrl }/learning-objects-approved-and-disapproved/${status}/?page=${page}`).pipe(map((data: any) => data));
  }
  ...
  getTeacherAndExpertToAproveProfile(id: number){
    return this.http.get(`${ baseUrl }/teacher-to-disapproved/${id}`).pipe(map((data: any) => data));
  }
  ...
  getTeacherAndExpertprovedProfile(id: number){
    ...
    return this.http.get(`${ baseUrl }/teacher-to-approve/${id}`).pipe(map((data: any) => data));
  }
  ...
  public deleteUserTeacher(idUser:number){
    return this.http.delete(`${ baseUrl }/teacher-to-approve-delete/${idUser}`);
  }
  ...
  public deleteUserExpert(idUser:number) {
    return this.http.delete(`${baseUrl}/expert-to-approve-delete/${idUser}`);
  } 
